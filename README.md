...
tiq.add(delay, function(currentQueueIndex,sameMethodCounter, _totalExecutions));
```
...
tiq.each(delay, function(currentQueueIndex,sameMethodCounter, _totalExecutions));
```
